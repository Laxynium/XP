...
public class GenerateAdvertisementsCsvFile extends MenuOption {

    private final AdvertisementService advertisementService;
    private final ConsoleReader consoleReader;

    public GenerateAdvertisementsCsvFile(PrintStream out) {
        super("Generate advertisements csv file", out);
